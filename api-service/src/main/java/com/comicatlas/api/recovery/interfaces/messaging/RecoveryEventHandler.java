...
import com.comicatlas.api.recovery.application.service.impl.RecoveryBatchServiceImpl;
...
public class RecoveryEventHandler {
    ...
    public RecoveryEventHandler(RecoveryEngine recoveryEngine, RecoveryTaskPersistencePort persistencePort,
            RedisTemplate<String, Object> redisTemplate, ManagementTaskService managementTaskService,
            MqConsumerSupport mqConsumerSupport) {
        this(new RecoveryBatchServiceImpl(recoveryEngine, persistencePort, redisTemplate, managementTaskService),
                mqConsumerSupport);
    }
