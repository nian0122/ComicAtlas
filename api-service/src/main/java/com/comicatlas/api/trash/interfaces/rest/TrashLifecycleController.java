package com.comicatlas.api.trash.interfaces.rest;

import com.comicatlas.api.trash.interfaces.rest.dto.PurgeRequest;
...
import com.comicatlas.api.trash.application.port.in.TrashCoverService;
import com.comicatlas.api.trash.application.port.in.TrashQueryService;
...
public class TrashLifecycleController {
    ...
    private final TrashCoverService trashCoverService;
    ...
    public ResponseEntity<Resource> cover(@PathVariable Long comicId) {
        Resource cover = trashCoverService.findCover(comicId);
        return cover == null ? ResponseEntity.notFound().build() : ResponseEntity.ok(cover);
    }
