...
public class MetadataUpdateCoordinator {
    ...
    private final MetadataTargetPersistencePort persistencePort;
    ...
    public void requestSyncForTarget(String targetType, Long targetId, Long taskId, String source) {
        Long comicId = persistencePort.resolveComicId(targetType, targetId).orElse(null);
        if (comicId == null) {
    ...
    private void flushSync(Long comicId, Long taskId, String source) {
        try {
            transactionTemplate.executeWithoutResult(status -> {
                if (!persistencePort.existsComic(comicId)) {
