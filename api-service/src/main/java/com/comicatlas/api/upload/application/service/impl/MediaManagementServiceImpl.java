...
import com.comicatlas.api.upload.interfaces.rest.dto.MediaReorderItem;
...
public class MediaManagementServiceImpl implements com.comicatlas.api.upload.application.port.in.MediaManagementService {
    // 媒体管理契约由应用服务公开，具体实现保持在上传业务包内。

    private final MediaManagementPersistencePort persistencePort;
    ...
    public MediaReorderResponse reorder(Long chapterId, MediaReorderRequest request) {
        ...
        // 阶段一：临时唯一负偏移
        persistencePort.movePageNumbersToTemporaryNegative(chapterId);
