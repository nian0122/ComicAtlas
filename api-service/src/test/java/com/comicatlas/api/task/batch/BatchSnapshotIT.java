...
class BatchSnapshotIT {
    ...
    @Autowired
    private com.comicatlas.api.task.batch.config.BatchProperties batchProperties;
    ...
    private List<ManagementTaskItemResponse> getTaskItems(long taskId) throws Exception {
        ...
        for (JsonNode n : arr) {
            ...
            it.setOperationType(com.comicatlas.api.task.enums.TaskType.valueOf(n.path("operationType").asText()));
