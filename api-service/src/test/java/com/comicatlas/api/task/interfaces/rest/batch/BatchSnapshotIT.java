package com.comicatlas.api.task.interfaces.rest.batch;
...
class BatchSnapshotIT {
    ...
    @Autowired
    private com.comicatlas.api.task.infrastructure.config.BatchProperties batchProperties;
    ...
    private List<ManagementTaskItemResponse> getTaskItems(long taskId) throws Exception {
        ...
        for (JsonNode n : arr) {
            ...
            it.setOperationType(com.comicatlas.api.task.domain.model.TaskType.valueOf(n.path("operationType").asText()));
