<template>
  <svg class="material-symbol-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
    <path
      v-if="name === 'play'"
      d="M6.5 5.5v13l11-6.5-11-6.5Z"
      fill="none"
      stroke="currentColor"
    ...
    <path
      ...
      d="M20 4v6h-6m6 0a8 8 0 1 0 1.1 6"
      fill="none"
      stroke="currentColor"
...
const paths: Readonly<Record<Exclude<MaterialIconName, 'play' | 'refresh'>, string>> = {
  ...
  library:
    'M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6Zm16-4H8a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4a2 2 0 0 0-2-2Zm-1 9H9V9h10v2Zm-4 4H9v-2h6v2Zm4-8H9V5h10v2Z',
}
</script>
