...
<style scoped src="@/styles/pages/management/comic-structure/intake.css"></style>
<style scoped src="@/styles/pages/management/comic-structure/browser.css"></style>
<style scoped src="@/styles/pages/management/comic-structure/actions.css"></style>
