...
export const hqApi = {
  ...
  deleteChapter: (chapterId: number) =>
    api.post<OperationSubmitResult>(`/manage/storage/delete-hq/chapters/${chapterId}`),
...
export const storageAdminApi = {
  ...
  transcodeComic: (comicId: number) => api.post<OperationSubmitResult>(`/manage/storage/transcode/comics/${comicId}`),
