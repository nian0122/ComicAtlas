<template>
  <div class="progressive-image" :style="containerStyle">
    ...
    <div v-if="showSkeleton" class="progressive-skeleton" />
    ...
    <!-- Retry / error state -->
    <div v-if="error" class="progressive-error" @click="retry">
...
watch(
  () => [props.lq, props.hq, props.mode, props.lqStatus, props.forceHq],
  () => {
    reset()
    if (props.active) {
      applyInitialSrc()
