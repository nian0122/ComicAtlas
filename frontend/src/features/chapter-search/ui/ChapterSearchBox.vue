...
.chapter-search-box:focus-within {
...
.chapter-search-box > input.unstyled-input {
  width: 100%;
  min-width: 0;
  border: 0;
  outline: 0;
...
.chapter-search-box > input.unstyled-input::placeholder {
  color: var(--text-muted);
}
.chapter-search-box > input.unstyled-input::-webkit-search-cancel-button {
  display: none;
}
.clear-button {
  display: inline-flex;
