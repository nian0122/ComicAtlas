...
import { directoryScanApi, importApi } from '@/features/import/model/api'
import type {
  BatchImportResultVO,
  ImportTaskVO,
  ImportStatusVO,
...
export const useImportStore = defineStore('import', () => {
  ...
  async function createBatch(sourceType: string, sourcePaths: string[]): Promise<BatchImportResultVO> {
    loading.value = true
    try {
