...
export const MANAGEMENT_TASK_TYPES: readonly ManagementTaskType[] = [
  ...
  'HQ_DELETE', 'TRANSCODE', 'METADATA_REFRESH', 'HQ_MEDIA_REGISTER', 'METADATA_UPDATE', 'COMIC_DELETE',
...
const MANAGEMENT_TASK_TYPE_LABELS: Readonly<Record<ManagementTaskType, string>> = {
  ...
  METADATA_REFRESH: '刷新元数据', HQ_MEDIA_REGISTER: '登记 HQ 媒体', METADATA_UPDATE: '更新元数据', COMIC_DELETE: '回收漫画',
