...
import type { ComicDetailVO, CatalogNode, ChapterRef } from '@/entities/comic/model/types'
import CatalogTree from '@/entities/comic/ui/CatalogTree.vue'
import MobileComicDetail from '@/widgets/comic-detail/MobileComicDetail.vue'
import { sourceTypeLabel } from '@/entities/comic/model/source-format'
import HeroBanner from '@/widgets/home/HeroBanner.vue'
...
import { chapterOrder, collectChapters, countChapters, findChapterById } from '@/entities/comic/model/catalog'
