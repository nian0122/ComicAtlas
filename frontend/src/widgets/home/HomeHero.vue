...
const title = computed(() => (props.historyItem ? props.historyItem.comicTitle : '开始探索你的漫画库'))
...
const subtitle = computed(() => {
  ...
  const progressText = progressPercent != null && progressPercent > 0 ? ` · 进度 ${progressPercent}%` : ''
