...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = ImportMetadataRefreshCompletedEvent.class, name = "ImportMetadataRefreshCompletedEvent"),
    @JsonSubTypes.Type(value = ImportMetadataRefreshFailedEvent.class, name = "ImportMetadataRefreshFailedEvent"),
...
public sealed interface ComicEvent
    permits ImportTaskCreatedEvent, ImportTaskCompletedEvent, ImportTaskFailedEvent,
            ...
            ImportMetadataRefreshCompletedEvent, ImportMetadataRefreshFailedEvent,
