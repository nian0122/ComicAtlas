...
public class TaskRepository {
    ...
    public record TaskRecord(long id, String sourcePath, TaskStatus status, int progress, String resultJson, String errorCode, String errorMessage, int attempts, Instant createdAt, Instant startedAt, Instant finishedAt) { }
}
