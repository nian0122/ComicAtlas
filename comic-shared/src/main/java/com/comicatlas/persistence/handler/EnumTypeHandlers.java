...
public class EnumTypeHandlers {
    ...
    @MappedTypes(com.comicatlas.contract.common.enums.TranscodeStatus.class)
    public static class TranscodeStatusHandler extends BaseTypeHandler<com.comicatlas.contract.common.enums.TranscodeStatus> {
        @Override public void setNonNullParameter(PreparedStatement ps, int i, com.comicatlas.contract.common.enums.TranscodeStatus p, JdbcType t) throws SQLException { ps.setString(i, p.name()); }
        @Override public com.comicatlas.contract.common.enums.TranscodeStatus getNullableResult(ResultSet rs, String c) throws SQLException { return safeValueOf(com.comicatlas.contract.common.enums.TranscodeStatus.class, rs.getString(c)); }
        @Override public com.comicatlas.contract.common.enums.TranscodeStatus getNullableResult(ResultSet rs, int c) throws SQLException { return safeValueOf(com.comicatlas.contract.common.enums.TranscodeStatus.class, rs.getString(c)); }
        @Override public com.comicatlas.contract.common.enums.TranscodeStatus getNullableResult(CallableStatement cs, int c) throws SQLException { return safeValueOf(com.comicatlas.contract.common.enums.TranscodeStatus.class, cs.getString(c)); }
    }
